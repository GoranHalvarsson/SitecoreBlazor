...
{
    public class ServerNavigationManager : NavigationManager
    {
        private readonly ILogger<ServerNavigationManager> _logger;
        ...
        public ServerNavigationManager(ILogger<ServerNavigationManager> logger)
        {
            _logger = logger;
        }
